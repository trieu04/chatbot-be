...
export class CookieService {
  ...
  constructor(
    ...
    this.AUTH_COOKIE_NAME = this.configService.get<string>("authCookie.name") || "fdac";
    this.AUTH_COOKIE_MAX_AGE = this.configService.get<number>("authCookie.maxAge") || 24 * 60 * 60 * 1000;
